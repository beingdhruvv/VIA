...
/**
 * CreateTripForm — full-featured trip creation form.
 * React Hook Form + Zod validation, POST to /api/trips,
 * redirect to builder on success, unsaved-changes guard.
 */
...
export function CreateTripForm() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    if (!res.ok) {
      ...
      // Surface API-level error in the form's root error slot (non-field)
      throw new Error(data.error ?? "Something went wrong. Please try again.");
    }

    const trip = await res.json();
    // Navigate away before the beforeunload guard fires
